...
# ---------------------------------------------------------------------------
# Convenience: Smith case as a SubmissionData literal
# ---------------------------------------------------------------------------


def smith_submission(pdf_bytes: bytes) -> SubmissionData:
    """Return the SubmissionData for the David Smith fixture, given the raw
    Smith PDF bytes. Used by scripts/seed_smith_case.py to keep the Smith
    case reproducible from one place."""
    return SubmissionData(
        ...
        cpt_display=(
            ...
            "with imaging guidance (e.g., fluoroscopy or CT)"
        ),
        service_date="2026-04-08",
        icd10_codes=[
            ICD10Code("M54.16", "Radiculopathy, lumbar region", "primary"),
            ICD10Code("M79.18", "Other myalgia", "secondary"),
            ICD10Code("M47.816", "Spondylosis without myelopathy or radiculopathy, lumbar region", "secondary"),
        ],
        body_site_display="Lumbar — L4/5 vs L5/S1",
        pdf_bytes=pdf_bytes,
        pdf_filename="David_Smith_Clinical.pdf",
        provider_org_name="NYU Langone Health — Center for the Study and Treatment of Pain",
        practitioner_family="Doe",
        practitioner_given="Jane",
        submission_timestamp="2026-04-01T09:00:00-04:00",
        doc_title="David_Smith_Clinical.pdf",
    )
